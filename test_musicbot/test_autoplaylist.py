...
@pytest.mark.asyncio
async def test_Precondition_LikeDislike(vanilla_apl, test_song):
...
async def test_UserLikeSong_NoPreviousSong(vanilla_apl, test_song, test_user):
    ...
    await test_Precondition_LikeDislike(vanilla_apl, test_song)
...
@pytest.mark.asyncio
async def test_AreSongsAvailable_SongsAvailable(vanilla_apl, test_song, test_user, test_other_user):
