...
def create_playlist(discord_username, suffix=""):
	DELIMETER = ":"
...
def lookup_video(video_id, playlist_id):
...
def add_video(playlist, video_id):
...
# Takes a playlist by name and a videos id
def remove_video(playlist, video_id):
	playlist_id = lookup_playlist(playlist)
	video_playlist_id = lookup_video(video_id, playlist_id)
	if playlist_id != None:
		if video_playlist_id != None:
