    ...
    def _deserialize(cls, data, playlist=None):
        ...
        try:
            ...
            if 'channel' in data['meta']:
                ...
                if not meta['channel']:
                    log.warning('Cannot find channel in an entry loaded from persistent queue. Channel id: {}'.format(data['meta']['channel']['id']))
                    meta.pop('channel')
...
class StreamPlaylistEntry(BasePlaylistEntry):
    ...
    async def _download(self, *, fallback=False):
        ...
        try:
            ...
            # for when ffmpeg inevitably fucks up and i have to restart
